...
def _build_default_policy(
    ...
    Grants GetSecretValue on ``secret_arn`` and sts:AssumeRole on the
    federation roles under ``federation_role_path`` in the caller's
...
def encode_credentials(
    ...
    Args:
        ...
        policy: Optional IAM session policy JSON string. If None, uses the
            ...
            the caller account's federation roles).
