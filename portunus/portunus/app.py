"""FastAPI app hosting admin endpoints (/ping, /cache/flush).

Customer auth/observability runs on the gRPC server in
:mod:`portunus.grpc` as Envoy ext_authz / ext_proc filters.
"""
...
async def lifespan(app: FastAPI):
    """Start the gRPC server (if enabled); drain and close on shutdown."""
