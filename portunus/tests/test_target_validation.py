...
class TestTargetValidation:
    ...
    def test_json_secret_with_mismatched_host_fails(self):
        ...
        with pytest.raises(
            ...
            self.validation_service.validate_and_extract_api_key(
                secret, "api.different.com"
            )
    ...
    def test_json_secret_with_host_but_no_target_fails(self):
        ...
        with pytest.raises(
            ...
            self.validation_service.validate_and_extract_api_key(secret, None)

    def test_json_secret_with_legacy_signing_key_ignores_it(self):
        """Secrets written for the removed request-signing feature still parse."""
