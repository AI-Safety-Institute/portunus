...
- `FEDERATION_ATTRIBUTION_KEY`: HMAC key for secrets with `attribution: pseudonymous` (a random secret of at least 32 bytes; needed only when a secret uses it)
